...
--
-- select DISTINCT(customers.name) from customers join orders on orders.customer_id = customers.id join bartenders
-- on bartenders.id = orders.bartenders_id where bartenders.name = 'moe' ;
